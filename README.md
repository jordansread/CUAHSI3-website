...
- **`content/research/`** is named `research` for URL continuity but the page is labeled "Highlights" — the mismatch is intentional but worth revisiting if the URL ever causes confusion.
