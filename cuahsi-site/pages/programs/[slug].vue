...
<template>
  <div>
    ...
    <div v-else-if="program">
      ...
      <div class="mx-auto" style="max-width:1240px;padding:52px 40px 80px;display:grid;grid-template-columns:minmax(0,1fr) 240px;gap:48px;">
        <div>
        ...
        <div>
          ...
          <div class="rounded-[12px]" style="border:1px solid rgba(15,33,43,.1);padding:20px;">
            ...
            <NuxtLink to="/highlights" class="block py-2 arrow-row" style="font:500 13.5px 'Hanken Grotesk';color:#1F6FB2;border-bottom:1px solid rgba(15,33,43,.06);">Program highlights →</NuxtLink>
