...
<template>
  <div>
    <div v-if="notFound" class="mx-auto text-center" style="max-width:720px;padding:80px 40px;">
      <NuxtLink to="/highlights" style="font:600 14px 'Hanken Grotesk';color:#1F6FB2;">← Back to highlights</NuxtLink>
    </div>
    <div v-else-if="item">
      <section style="background:linear-gradient(180deg,#FBFAF7,#F3EEE4);border-bottom:1px solid rgba(15,33,43,.08);">
        <div class="mx-auto" style="max-width:1240px;padding:52px 40px 48px;">
          <p class="font-mono text-[11px] text-muted mb-3"><NuxtLink to="/highlights" style="color:#5C6E78;">← Highlights</NuxtLink></p>
      ...
      <div class="mx-auto" style="max-width:760px;padding:52px 40px 80px;">
        ...
        <div class="mt-10 pt-8" style="border-top:1px solid rgba(15,33,43,.08);">
          <NuxtLink to="/highlights" class="arrow-row inline-flex items-center gap-2" style="font:600 14px 'Hanken Grotesk';color:#1F6FB2;"><span style="transform:scaleX(-1);display:inline-block;">→</span> All highlights</NuxtLink>
        </div>
      </div>
    </div>
  </div>
