...
// once available; currently placeholder data pending the real 130+ roster.
  ...
  <div>
    <section style="background:linear-gradient(180deg,#FBFAF7,#F3EEE4);border-bottom:1px solid rgba(15,33,43,.08);">
      <div class="mx-auto" style="max-width:1240px;padding:64px 40px 52px;">
        ...
        <p style="font:400 16px/1.6 'Hanken Grotesk';color:#3a4d57;max-width:560px;margin-bottom:24px;">CUAHSI membership connects your institution to shared infrastructure, training programs, governance, and a network of 130+ universities advancing water science together.</p>
    ...
    <div class="mx-auto site-container" style="max-width:1240px;padding-top:52px;padding-bottom:24px;">
      <p style="font:400 15px/1.65 'Hanken Grotesk';color:#3a4d57;max-width:620px;margin-bottom:16px;">Member institutions gain access to HydroShare, JupyterHub, MATLAB Online, discounts on training and consulting through <NuxtLink to="/services" style="color:#1F6FB2;">Hire CUAHSI</NuxtLink>, representation in CUAHSI governance, and priority access to new programs and pilots.</p>
